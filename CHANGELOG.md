...
### Sửa Lỗi API & Cải Thiện Script

**Bug Fixes:**
- script): Chỉnh sửa Script Auto Release
- api): khắc phục phản hồi null và tối ưu hóa bộ kiểm thử (tỷ lệ đạt 97%)
- docker): Sửa update-deloy.sh
...
- Release URL: https://github.com/MNM-DTU-DZ/CityResQ360-DTUDZ/releases/tag/v1.0.3

---

# [](https://github.com/MNM-DTU-DZ/CityResQ360-DTUDZ/compare/v1.0.2...v) (2025-11-29)
