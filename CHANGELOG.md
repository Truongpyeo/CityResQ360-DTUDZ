...
**✨ New Features:**
- tích hợp hệ thống IoT và kiến trúc event-driven với RabbitMQ
- update mobile
...
**🐛 Bug Fixes:**
- thêm 5 phương thức còn thiếu trong ReportController
- !: liên kết media với report qua phan_anh_id
- Fix nginx default
- !: sửa lỗi deployment và thêm script rebuild an toàn
- resolve port 8004 conflicts in production
- replace l5-swagger class constant with hardcoded value for docker build
...
**📚 Documentation:**
- thêm GPL-3.0 license headers cho tất cả source files
...
- xóa wallet-service và thêm 5 microservices mới vào docker-compose

**⚠️ BREAKING CHANGES:**
- fix(apip)!: liên kết media với report qua phan_anh_id
- fix(docker)!: sửa lỗi deployment và thêm script rebuild an toàn

**Technical Details:**
- Tag: v2.0.0
- Commits: 78
- Released from: master branch
- Release URL: https://github.com/MNM-DTU-DZ/CityResQ360-DTUDZ/releases/tag/v2.0.0
