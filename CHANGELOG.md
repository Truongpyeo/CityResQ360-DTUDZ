...
* **aiml:** fix syntax error in logger line ([37e48ab](https://github.com/MNM-DTU-DZ/CityResQ360-DTUDZ/commit/37e48ab330ee2c40b7b752d2be06051216f6ea2a))
* **aiml:** handle DB connection errors in optional_authenticate ([9507bcc](https://github.com/MNM-DTU-DZ/CityResQ360-DTUDZ/commit/9507bcccf7952ad40e47de89aa741e0268b67b1b))
* **aiml:** handle None user in analyze-for-report endpoint ([bb8ab4e](https://github.com/MNM-DTU-DZ/CityResQ360-DTUDZ/commit/bb8ab4ec16e78f150ef251e6872bc56dfd8b03a1))
...
* **auth:** use correct DB column push_token instead of fcm_token ([2854dcd](https://github.com/MNM-DTU-DZ/CityResQ360-DTUDZ/commit/2854dcdeee1b8e5f109fb098daf5e19808a7b2c2))
...
* **firebase:** ensure credentials path is always absolute ([f07f005](https://github.com/MNM-DTU-DZ/CityResQ360-DTUDZ/commit/f07f0050546c4f1639b72b6ffaea474ac57c58ca))
* **firebase:** fix MessagingException error handling for SDK compatibility ([6c7d012](https://github.com/MNM-DTU-DZ/CityResQ360-DTUDZ/commit/6c7d012d9034e37c73ac1bff179fc2565a5c59bf))
* **media:** align upload path with MediaService structure (YYYY/MM/DD) ([a4ff9c2](https://github.com/MNM-DTU-DZ/CityResQ360-DTUDZ/commit/a4ff9c2a41c33f0c2ac759bcf5e8094956474e22))
* **media:** construct public URLs directly with correct MinIO bucket path ([e6576bb](https://github.com/MNM-DTU-DZ/CityResQ360-DTUDZ/commit/e6576bb5e691d1f85abeae3b3319610175b6d075))
* **media:** correct URL path conversion for MinIO bucket structure ([a24325e](https://github.com/MNM-DTU-DZ/CityResQ360-DTUDZ/commit/a24325e3a9cfdbf6236e6b648bc4fe79c7296723))
...
* **media:** hardcode bucket name and fix URL path slashes ([029b00b](https://github.com/MNM-DTU-DZ/CityResQ360-DTUDZ/commit/029b00bd27ecb4411cd52307419a1555a83eea3e))
* **media:** hardcode S3 disk to ensure MinIO upload ([c1e797a](https://github.com/MNM-DTU-DZ/CityResQ360-DTUDZ/commit/c1e797affb919cfe3b697d5dc2418e78f048d97f))
